...
import { lastWeekDate, todayDate } from "../Components/DateComponent";
import { Chart } from "react-google-charts";

export const options = {
  title: "Generation Mix Last Week",
  pieHole: 0.4,
  is3D: false,
};

export default function Last7DaysData() {
  const fuels = [
    "biomass",
    "coal",
    "imports",
  ...
  //API calling.....................
  const fetchWeek = (dateFrom = lastWeekDate, dateTo = todayDate) => {
    const curl =
